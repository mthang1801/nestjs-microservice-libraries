...
import { CustomTransportStrategy, OutgoingResponse, Server, Transport } from '@nestjs/microservices';
...
import { PublishOptions, RMQServerOptions, RMQServerResponse } from '../interfaces/rmq-options.interface';
...
export class RabbitMQServer extends Server implements CustomTransportStrategy {
	...
	public sendMessage(message: RMQServerResponse, replyTo: any, correlationId: string): void {
